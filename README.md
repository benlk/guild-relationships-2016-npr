...
**TKTK: Describe guild-relationships-2016-npr here.**
...
```
cd guild-relationships-2016-npr
mkvirtualenv guild-relationships-2016-npr
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=13Npn_PYjXy9eLsVZSjETmYXNyw-NEqq0tP8M8LyztFU#gid=0).
...
def read_my_google_doc():
    ...
    get_document('13Npn_PYjXy9eLsVZSjETmYXNyw-NEqq0tP8M8LyztFU', file_path)
    data = Copy(file_path)
...
```
workon guild-relationships-2016-npr
fab render
```
...
```
* * * * * ubuntu bash /home/ubuntu/apps/guild_relationships_2016_npr/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|guild-relationships-2016-npr|tweet|`location`||
|guild-relationships-2016-npr|facebook|`location`||
|guild-relationships-2016-npr|email|`location`||
|guild-relationships-2016-npr|new-comment||
|guild-relationships-2016-npr|open-share-discuss||
|guild-relationships-2016-npr|close-share-discuss||
|guild-relationships-2016-npr|summary-copied||
|guild-relationships-2016-npr|featured-tweet-action|`action`|
|guild-relationships-2016-npr|featured-facebook-action|`action`|
